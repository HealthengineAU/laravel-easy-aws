...
return [
    ...
    */
    ...
    'table_name' => env('DYNAMODB_TABLE_NAME', 'SETME'),
    ...
    */
    ...
    'connections' => [
        ...
        'local' => [
            ...
            'endpoint' => env('DYNAMODB_LOCAL_ENDPOINT', 'https://localstack.dev.he0.io'),
            'debug' => env('DYNAMODB_DEBUG'),
        ],
        'test' => [
            'credentials' => [
            ...
            'region' => 'us-east-1',
            'endpoint' => env('DYNAMODB_TEST_ENDPOINT', 'https://localstack.dev.he0.io'),
            'debug' => env('DYNAMODB_DEBUG'),
        ],
    ],
];
